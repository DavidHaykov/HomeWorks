...
public class RentCompanyProtocol implements ProtocolJava {
    ...
    public ResponseJava getResponse(RequestJava request) {
        try {
            String methodName =  request.requestType.replaceAll("/", "_");
            return (ResponseJava) this.getClass().getDeclaredMethod(methodName, Serializable.class).invoke(this, request.requestData);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
